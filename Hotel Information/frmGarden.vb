...
Public Class frmGarden
    ...
    Private Const STR_SelectCountFromGardenHavingCount1 As String = "select count(*) from Garden Having count(*) >= 1"
    Private Const STR_RecordAlreadyExists As String = "Record Already Exists"
    Private Const STR_InsertIntoGardenChargesVALUES As String = "insert into Garden(Charges) VALUES ("
    Private Const STR_SuccessfullySaved As String = " Garden Successfully saved"
    Private Const STR_DoYouReallyWantToDeleteThisRecord As String = "Do you really want to delete this record?"
    Private Const STR_DeleteFromGardenWhereID As String = "delete from Garden where ID="
    ...
    Private Const STR_UpdateGardenSetCharges As String = "update Garden set Charges = "
    Private Const STR_SuccessfullyUpdated As String = "Successfully updated"
    Private Const STR_SELECTFromGarden As String = "SELECT * from Garden "
    ...
    Private Sub btnSave_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnSave.Click
        ...
        Try
            ...
            con.Open()
            Dim ct As String = STR_SelectCountFromGardenHavingCount1
            ...
            con = New OleDbConnection(cs)
            con.Open()
            Dim cb As String = STR_InsertIntoGardenChargesVALUES & txtCharges.Text & ")"
    ...
    Public Sub DeleteRecord()
        Try
            ...
            con = New OleDbConnection(cs)
            con.Open()
            Dim cq As String = STR_DeleteFromGardenWhereID & txtID.Text & ""
    ...
    Private Sub btnUpdate_record_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnUpdate_record.Click
        Try
            ...
            con = New OleDbConnection(cs)
            con.Open()
            Dim cb As String = STR_UpdateGardenSetCharges & txtCharges.Text & " where ID= " & txtID.Text & ""
            cmd = New OleDbCommand(cb)
            cmd.Connection = con
            cmd.ExecuteReader()
    ...
    Sub GetData()
        Try
            con = New OleDbConnection(cs)
            con.Open()
            cmd = New OleDbCommand(STR_SELECTFromGarden, con)
