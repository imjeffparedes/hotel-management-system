...
Public Class frmEmployeeAttendanceRecord
    Private Const STR_SelectWorkingDateAsWorkingDateStatusAsStatusInTi As String = "select (WorkingDate) as [Working Date],(Status) as [Status], (InTime) as [In Time],(OutTime) as [Out Time],(Overtime) as [Overtime] from employeeAttendance where WorkingDate between #"
    Private Const STR_SelectCountstatusFromEmployeeattendanceWhereWork As String = "select count(status) from employeeattendance where WorkingDate between #"
    Private Const STR_SelectEmployeenameFromEmployeeattendanceEmployee As String = "select employeename from employeeattendance,EmployeeRegistration where EmployeeRegistration.EmployeeID=EmployeeAttendance.EmployeeID and EmployeeRegistration.employeeid=@find"
    Private Const STR_SELECTEmployeeNameAsEmployeeNameEmployeeIDAsEmpl As String = "SELECT (EmployeeName) as [Employee Name],(EmployeeID) as [Employee ID] FROM EmployeeRegistration order by employeename"
    ...
    Private Const STR_SELECTDistinctEmployeeidFROMEmployeeattendance As String = "SELECT distinct (employeeid) FROM employeeattendance"
    ...
    Sub fillcombo()
        ...
        Try
            ...
            adp.SelectCommand = New OleDbCommand(STR_SELECTDistinctEmployeeidFROMEmployeeattendance, CN)
            ds = New DataSet("ds")
    ...
    Private Sub button4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles button4.Click
        Try
            ...
            con.Open()
            cmd = New OleDbCommand(STR_SelectWorkingDateAsWorkingDateStatusAsStatusInTi & DateFrom.Text & "# And #" & DateTo.Text & "# and EmployeeId='" & EmployeeID.Text & "' order by workingdate", con)
            ...
            Dim cp As String = STR_SelectCountstatusFromEmployeeattendanceWhereWork & DateFrom.Text & "# And #" & DateTo.Text & "# and status='P' and  employeeid=@find "
            ...
            Dim cp1 As String = STR_SelectCountstatusFromEmployeeattendanceWhereWork & DateFrom.Text & "# And #" & DateTo.Text & "# and  employeeid=@find "
    ...
    Private Sub EmployeeID_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles EmployeeID.SelectedIndexChanged
        Try
            ...
            con = New OleDbConnection(cs)
            con.Open()
            Dim ct As String = STR_SelectEmployeenameFromEmployeeattendanceEmployee
    ...
    Public Function GetData() As DataView
        Dim SelectQry = STR_SELECTEmployeeNameAsEmployeeNameEmployeeIDAsEmpl
